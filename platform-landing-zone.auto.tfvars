...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "jens.diedrich@googlemail.com"
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "identity-tf-hubspoke-single3"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "connectivity-tf-hubspoke-single3"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "management-tf-hubspoke-single3"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "security-tf-hubspoke-single3"
    }
  }
  policy_assignments_to_modify = {
    alz-tf-hubspoke-single3 = {
      policy_assignments = {
